...
## Notes
* I used Anaconda and Python 3.8 to install PyTorch 1.8 from Oregon State University's Open Source Lab without too many problems (https://osuosl.org/services/powerdev/opence/). I did encounter an SSL certificate error, which I fixed (export REQUESTS_CA_BUNDLE=/usr/local/share/ca-certificates/<my-cert-name>).
